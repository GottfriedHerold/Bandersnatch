...
// a zero [reflect.Value] appearing as input to fun -- such as the result of [reflect.ValueOf](nil) -- is actually treated as nil rather than a panic-causing invalid [reflect.Value].
