...
var (
	LittleEndian FieldElementEndianness = FieldElementEndianness{byteOrder: binary.LittleEndian}
	BigEndian    FieldElementEndianness = FieldElementEndianness{byteOrder: binary.BigEndian}
)
