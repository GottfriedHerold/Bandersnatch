...
// This value is 2*GroupOrder rather than 4*GroupOrder, because the cofactor group has structure Z/2 x Z/2.
...
//
// Note: While we use additive notation for the group, this constant is still called exponent, because it matches the general definition of the exponent of a group, often written exp(G) for arbitrary groups G.
const (
