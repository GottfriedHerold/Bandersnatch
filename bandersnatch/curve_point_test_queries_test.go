...
func test_queries(t *testing.T, receiverType PointType, excludedFlags PointFlags) {
	...
	make_samples1_and_run_tests(t, checkfun_IsNaP_consistentAXTW, "IsNaP inconsistent with conversion to axtw "+point_string, receiverType, 50, excludedFlags|Case_infinite)
